  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#F9FAFB] pt-8 pb-8 sm:pt-12 sm:pb-12 md:pt-16 md:pb-16 lg:pt-24 lg:pb-40">
      <div className="w-full max-w-[1404px] mx-auto px-4 sm:px-6 md:px-8">
        <h2 className="text-center text-[#89A884] mb-4">
          Apply for this job
        </h2>
          ...
          <AnimatePresence mode="wait">
            ...
            {step === 5 && (
              <motion.div
                ...
                transition={{ duration: 0.2 }}
              >
                <div className="max-w-[1216px] m-auto text-center min-h-[300px] sm:min-h-[350px] md:min-h-[400px] flex flex-col items-center justify-center px-4">
                  <p className="font-[Erstoria] font-[400] text-3xl sm:text-4xl md:text-6xl text-[#89A884]">
                    THANK YOU !
                  </p>
                  <p className="font-[Salmond] font-[500] text-[#494B49] text-lg sm:text-xl md:text-2xl mt-2">
