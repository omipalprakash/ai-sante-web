...
import { marqueeData, useElementWidth } from "./constants";
import styles from "./scroll_velocity.module.css";


export const Logo_Scroller = ({
  scrollContainerRef,
  texts = marqueeData.upper,
  velocity = 100,
  className = "",
  damping = 50,
  stiffness = 400,
